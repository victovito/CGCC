/* Atividade do Módulo 5 - Victor Silva da Rosa */
...
const string windowName = "Módulo 5 - Victor Silva da Rosa";
const string vertexShaderSource = "../src/shaders/modulo5/vertex.shader.glsl";
const string fragmentShaderSource = "../src/shaders/modulo5/fragment.shader.glsl";
